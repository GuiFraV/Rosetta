    ...
    <nav class="navbar navbar-light navbar-expand-lg" style="background-color: #e3f2fd;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                <a class="navbar-brand" href="{{ route('admin.dashboard') }}"><img width="140"  src="http://www.intergate-group.com/wp-content/uploads/2017/11/intergate-group.png" alt="Intergate Group"></a>
                <ul class="navbar-nav">
                    @guest
                    
                    @else
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.managers.store') }}">Managers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.partners.index') }}">Partners</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="nav-link" href="{{ url('hourssend') }}">Sending schedules</a>
                        </div>
                    </li> --}}
