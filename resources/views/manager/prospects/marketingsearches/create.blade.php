...
@section('content')
    <div class="container col-6">
        <h2>Add a new marketing search</h2><br>
        @if ($errors->any())
        ...
        @endif
        <form method="post" action="{{ route('manager.marketingsearch.store') }}">
            @csrf    
            <div class="row">
                <div class="col">
            ...
            <div class="float-end">
                ...
                <button type="submit" class="btn btn-primary">Add marketing search</button>
            </div>
        </form>
    </div>
